...
* `id` - (Optional) The unique identifier of the `app_role`. When not specified, a unique `id` will be generated by Azure and this is the recommended approach. You can specify your own `id` and this should always be a valid UUID.
